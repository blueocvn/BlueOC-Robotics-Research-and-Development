...
# Register this project's tasks with gymnasium. Isaac Lab's own train.py/play.py only
# import isaaclab_tasks, so an external task like ours would otherwise be NameNotFound.
# This line must run *after* the Sim app is launched above (env cfgs import isaaclab.sim).
